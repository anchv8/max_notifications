...
// Примечание: "завершено с ошибками" присутствует и в subjectErrorPrefixes — намеренно:
// уровень 1 ловит точное начало темы (регистрозависимо), уровень 2 — фразу в любом месте (регистронезависимо).
